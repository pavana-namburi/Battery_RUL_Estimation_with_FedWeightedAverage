...
# CNN-LSTM-ATTENTION + FedWeightedAvg
#
# SUBGROUP 1:
#   client_1 -> B0005
#   client_2 -> B0006
...
ALPHA = float(os.environ.get("ALPHA", 5.0))
...
# ============================================================
# 16. SAVE CLIENT ATTENTION WEIGHTS
# ============================================================
...
def train_subgroup(
    ...
    global_model = CNNLSTMAttention().to(
        DEVICE
    )
    ...
    # ========================================================
    # 17.8 RESTORE BEST GLOBAL MODEL
    # ========================================================
    ...
    # ========================================================
    # 17.10 SAVE GLOBAL VALIDATION HISTORY
    # ========================================================
    ...
    # ========================================================
    # 17.12 SAVE GLOBAL TEST METRICS
    # ========================================================
    ...
    # ========================================================
    # 17.15 SAVE CLIENT ATTENTION WEIGHTS
    # ========================================================
    ...
    # ========================================================
    # 17.16 SAVE CONVERGENCE INFORMATION
    # ========================================================
...
def main():
    ...
    subgroup_filter = os.environ.get("SUBGROUP_FILTER")
    ...
    if subgroup_filter:
        print(
            ...
            f" FOR SUBGROUP: {subgroup_filter}"
        )
    else:
        print(
    ...
    # --------------------------------------------------------
    # Run only the requested subgroup when SUBGROUP_FILTER
    # is provided by the alpha sensitivity wrapper.
    # Otherwise, run both subgroups normally.
    # --------------------------------------------------------

    if subgroup_filter:

        if subgroup_filter not in SUBGROUPS:
            raise ValueError(
                f"Invalid SUBGROUP_FILTER: {subgroup_filter}. "
                f"Expected one of: {list(SUBGROUPS.keys())}"
            )

        subgroup_config = SUBGROUPS[subgroup_filter]
        ...
        print("#" * 70)
        print(
            f"# SUBGROUP {subgroup_filter} COMPLETED"
        )
        print("#" * 70)
