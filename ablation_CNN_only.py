...
#
# IMPORTANT:
#   This script does NOT modify the existing baseline outputs.
#
# Existing baseline:
#   outputs/output_5_18/
...
#
# New outputs:
#   ablation_results/CNN_only/5_18/
#   ablation_results/CNN_only/25_28/
#
# SAFETY:
#   If an experiment output directory already contains ANY
#   files or folders, that experiment is NOT run.
#
...
print("=" * 70)
print("CNN-ONLY FEDERATED LEARNING ABLATION")
print("=" * 70)
...
# BASE_DIR is automatically the directory containing this file.
# ============================================================
...
# Same alpha as the existing baseline.
ALPHA = 5.0
...
#
# Architecture:
#   CNN -> ReLU -> Global Average Pooling -> FC
#
# No LSTM.
# No attention.
# ============================================================
...
# ============================================================
# 14. FEDERATED MODEL AGGREGATION
# ============================================================
...
def train_subgroup(
    ...
    print("=" * 70)
    print(
        f"CNN-ONLY | SUBGROUP: {subgroup_name}"
    )
    print("=" * 70)
    ...
    # --------------------------------------------------------
    # Safety check BEFORE any output is written
    # --------------------------------------------------------
    ...
    print(
        f"\nCNN-only {subgroup_name} completed."
    )
...
def main():
    ...
    print("\n")
    print("#" * 70)
    print("# CNN-ONLY ABLATION COMPLETE")
    print("#" * 70)
